...
class PluginActivity : AppCompatActivity() {
        ...
        override fun onCreate(savedInstanceState: Bundle?) {
                ...
                if (!isSupported(uri)) {
                        if (isApk) {
                                // APK files from Tachiyomi/Keiyoushi extensions are not
                                // directly supported yet — inform the user instead of
        ...
        /**
         * Show a dialog explaining that Tachiyomi/Keiyoushi .apk extensions
         * are not yet supported, instead of crashing or silently failing.
         */
